...
<section id="intro" class="bottom-shadow">
	...
	<div class="col-xs-12 col-md-8 center">
		<img src="images/prod-logos-space_1.png" alt="ravn-logo" class="logo-vertical">
		<img src="images/prod-logos-space_2.png" alt="ravn-logo" class="logo-vertical">
	</div>
</section>
...
<section>
	...
	<div class="col-xs-12 col-md-4 center">
		...
		<?php include("prodlog1.php"); ?>

	</div>
	<div class="col-xs-12 col-md-4 center">
		
		<?php include("prodlog2.php"); ?>

	</div>
	<div class="col-xs-12 col-md-4 center">
		
		<?php include("prodlog3.php"); ?>
